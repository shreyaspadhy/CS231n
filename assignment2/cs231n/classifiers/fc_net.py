...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        relu, cache_relu = relu_forward(h1)
        h2, cache_h2 = affine_forward(relu, self.params['W2'], self.params['b2'])
        ...
        dh2, grads['W2'], grads['b2'] = affine_backward(dout, cache_h2)
        drelu = relu_backward(dh2, cache_relu)
        dh1, grads['W1'], grads['b1'] = affine_backward(drelu, cache_h1)
